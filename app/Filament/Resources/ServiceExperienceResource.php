...
class ServiceExperienceResource extends LmpResource
{
    protected static ?string $model = ServiceExperience::class;
    ...
    protected static ?string $modelLabel = 'filament.resources.service_experience';

    protected static ?string $pluralModelLabel = 'filament.resources.service_experiences';
            ...
            return Section::make($lang->display_name)
                ->schema([
                    TextInput::make("translations.{$lang->id}.name")
                        ->label(__('filament.resources.service_experience_fields.name'))
                        ->maxLength(255),
                ])
                ->columns(2)
                ->collapsible();
        ...
        return [
            Tabs::make()
                ->tabs([
                    ...
                    Tab::make(__('filament.resources.service_experience_tabs.translations'))
    ...
    public static function table(Table $table): Table
    {
        return parent::table($table)
            ->columns([
                TextColumn::make('id')
                    ->label(__('filament.resources.service_experience_columns.id'))
                    ->sortable(),
                ...
                TextColumn::make('name')
                    ->label(__('filament.resources.service_experience_columns.name'))
    ...
    {
        return [
            'index' => Pages\ListServiceExperiences::route('/'),
            'create' => Pages\CreateServiceExperience::route('/create'),
            'view' => Pages\ViewServiceExperience::route('/{record}'),
            'edit' => Pages\EditServiceExperience::route('/{record}/edit'),
        ];
    }
}
