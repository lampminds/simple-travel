...
class CreateServiceGastronomyCuisine extends LmpCreateRecord
{
    ...
    protected function syncTranslations(ServiceGastronomyCuisine $record, array $translations): void
    {
