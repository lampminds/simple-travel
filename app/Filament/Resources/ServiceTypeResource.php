...
class ServiceTypeResource extends LmpResource
{
    ...
    protected static ?string $modelLabel = 'filament.resources.service_type';

    protected static ?string $pluralModelLabel = 'filament.resources.service_types';
    ...
    protected static function getMainFormSchema(Schema $schema): array
    {
        ...
        return [
            Tabs::make()
                ->tabs([
                    Tab::make(__('filament.resources.service_type_tabs.general'))
                        ->schema([
                            Section::make('')->schema([
                                TextInput::make('code')
                                    ->label(__('filament.resources.service_type_fields.code'))
                                    ->placeholder(__('filament.resources.service_type_fields.code'))
                                    ->required()
                                    ->maxLength(255),
                                Toggle::make('active')
                    ...
                    Tab::make(__('filament.resources.service_type_tabs.translations'))
    ...
    public static function table(Table $table): Table
    {
        return parent::table($table)
            ->columns([
                TextColumn::make('id')
                    ->label(__('filament.resources.service_type_columns.id'))
                    ->sortable(),
                ...
                TextColumn::make('code')
                    ->label(__('filament.resources.service_type_columns.code'))
                    ->searchable()
                    ->sortable(),
                TextColumn::make('name')
                    ->label(__('filament.resources.service_type_columns.name'))
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => Pages\ViewServiceType::route('/{record}'),
