...
class ContactPosition extends Model
{
    ...
    protected $table = 'cat_contact_positions';
    ...
    /**
     * Get the translations for this position (one per language).
     */
    public function translations(): HasMany
    {
        return $this->hasMany(ContactPositionTranslation::class);
    }
     ...
     */
    protected function getTranslationForDisplay(): ?ContactPositionTranslation
    {
