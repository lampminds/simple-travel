...
class OperatorPackageConditionOverride extends Model
{
    use AuditTrait;
    ...
    {
        return $this->belongsTo(OperatorServiceCatalog::class, 'operator_package_id');
    }
    ...
    {
        return $this->hasMany(OperatorPackageConditionOverrideTranslation::class, 'operator_package_condition_override_id');
    }
}
