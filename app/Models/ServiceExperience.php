...
class ServiceExperience extends Model
{
    ...
    protected $table = 'cat_service_experiences';
    ...
    {
        return $this->hasMany(ServiceExperienceTranslation::class);
    }
     ...
     */
    protected function getTranslationForDisplay(): ?ServiceExperienceTranslation
    {
