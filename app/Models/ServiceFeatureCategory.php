...
class ServiceFeatureCategory extends Model
{
    ...
    {
        return $this->hasMany(ServiceFeature::class, 'service_feature_category_id');
    }
    ...
    /**
     * Translation to use for display. Prefers the translation matching app locale.
     */
