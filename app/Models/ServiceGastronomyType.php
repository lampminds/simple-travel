...
class ServiceGastronomyType extends Model
{
    use HasFactory, AuditTrait;

    protected $table = 'cat_service_gastronomy_types';
    ...
    /**
     * Get the translations for this gastronomy type (one per language).
     */
    public function translations(): HasMany
    {
        return $this->hasMany(ServiceGastronomyTypeTranslation::class);
    }
     ...
     */
    protected function getTranslationForDisplay(): ?ServiceGastronomyTypeTranslation
    {
