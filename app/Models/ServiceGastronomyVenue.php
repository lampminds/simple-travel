...
class ServiceGastronomyVenue extends Model
{
    use HasFactory, AuditTrait;

    protected $table = 'cat_service_gastronomy_venues';
    ...
    /**
     * Get the translations for this venue (one per language).
     */
    public function translations(): HasMany
    {
        return $this->hasMany(ServiceGastronomyVenueTranslation::class);
    }
     ...
     */
    protected function getTranslationForDisplay(): ?ServiceGastronomyVenueTranslation
    {
