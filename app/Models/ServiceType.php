...
class ServiceType extends Model
{
    ...
    protected $table = 'cat_service_types';
    ...
    /**
     * Get the translations for this service type (one per language).
     */
     ...
     */
    protected function getTranslationForDisplay(): ?ServiceTypeTranslation
    {
