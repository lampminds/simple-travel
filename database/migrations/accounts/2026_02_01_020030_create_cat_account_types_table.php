...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('cat_account_type_translations', function (Blueprint $table) {
            $table->id();
            $table->foreignId('account_type_id')->constrained('cat_account_types');
    ...
    {
        Schema::dropIfExists('cat_account_type_translations');
