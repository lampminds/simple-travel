...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('cat_service_experience_translations', function (Blueprint $table) {
            $table->id();
            $table->foreignId('service_experience_id')
                ->constrained('cat_service_experiences', 'id', 'se_translations_fk')
                ->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('cat_service_experience_translations');
        Schema::dropIfExists('cat_service_experiences');
    }
};
