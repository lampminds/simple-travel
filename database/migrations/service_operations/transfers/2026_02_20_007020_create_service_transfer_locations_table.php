...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('service_transfer_locations', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('city_id')->nullable(); // refers to addons.lmp_cities table
            $table->string('slug')->nullable();
            $table->decimal('latitude', 10, 7)->nullable();
            $table->decimal('longitude', 10, 7)->nullable();

            $table->string('airport_code', 10)->nullable();
            $table->foreignId('parent_id')->nullable()->constrained('service_transfer_locations', 'id', 'stl_parent_fk');
