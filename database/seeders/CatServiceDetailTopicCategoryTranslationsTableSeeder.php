...
class CatServiceDetailTopicCategoryTranslationsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $this->withoutForeignKeyChecks(function (): void {
            ...
            array (
                'id' => 16,
                'service_detail_topic_category_id' => 13,
                'language_id' => 2,
                'name' => 'Operación interna',
                'description' => 'Notas y procesos internos del equipo y del prestador',
            ),
        ));
        });
    }
