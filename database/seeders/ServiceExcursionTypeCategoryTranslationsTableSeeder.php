...
class ServiceExcursionTypeCategoryTranslationsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('cat_service_excursion_type_category_translations')->delete();
        
        \DB::table('cat_service_excursion_type_category_translations')->insert(array (
            0 => 
            array (
                'id' => 1,
