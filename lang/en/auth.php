...
return [
    ...
    'login' => [
        ...
        'pending_invitation' => 'Complete your employee invitation (set your password or use the Google/Facebook link from the email) before signing in.',
    ...
    'register' => [
        ...
        'contact_department' => 'Your department',
        'contact_position' => 'Your position (role)',
        'select_contact_department' => 'Select department…',
        'select_contact_position' => 'Select position…',
        'your_name' => 'Your name',
        'email' => 'Email',
        'password' => 'Password',
