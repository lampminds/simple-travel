...
return [
    ...
    'tasks_list_footer_after_link' => ' section.',
    'tasks_list_footer_plain' => 'You can always find this list in the Tasks section.',
    'todo_heading' => 'Recommended first steps',
    'cta' => 'Go to account dashboard',
];
