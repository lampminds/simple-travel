...
return [
    ...
    'register' => [
        ...
        'important_text' => 'Si ya existe una cuenta para tu empresa no debes registrarte aquí sino desde una invitación del administrador de tu empresa (esto lo implementaremos más adelante).',
