...
return [
    ...
    'login' => [
        ...
        'social_existing_user_use_password' => 'Ya existe una cuenta con ese email. Ingresá con email y contraseña.',
        'pending_invitation' => 'Completá tu invitación de empleado (definí tu contraseña o usá el enlace de Google/Facebook del email) antes de iniciar sesión.',
    ...
    'register' => [
        ...
        'select_contact_department' => 'Seleccioná departamento…',
        'select_contact_position' => 'Seleccioná cargo…',
        'your_name' => 'Tu nombre',
        'email' => 'Email',
        'password' => 'Contraseña',
        ...
        'social_auth_failed' => 'No se pudo completar el acceso con la red social. Intentá nuevamente.',
        'social_email_required' => 'No pudimos obtener tu email desde la red social. Usá el formulario de registro.',
