...
return [
    'html5' => [
        ...
        'type_mismatch_url' => 'Introduce una URL válida.',
        'pattern_mismatch' => 'Usa el formato solicitado.',
        'too_short' => 'Este texto es demasiado corto.',
        'too_long' => 'Este texto es demasiado largo.',
        'range_underflow' => 'El valor es demasiado bajo.',
