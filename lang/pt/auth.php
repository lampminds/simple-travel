...
return [
    ...
    'login' => [
        ...
        'social_invitation_only' => 'O acesso social está disponível apenas para convites de colaborador.',
        'social_invitation_only_help' => 'O login com Google/Facebook está disponível apenas a partir de um link de convite de colaborador.',
        'social_existing_user_use_password' => 'Já existe uma conta com esse e-mail. Inicie sessão com e-mail e palavra-passe.',
        'pending_invitation' => 'Conclua o seu convite de colaborador (defina a palavra-passe ou use a ligação Google/Facebook do e-mail) antes de iniciar sessão.',
    ...
    'register' => [
        ...
        'contact_department' => 'O seu departamento',
        'contact_position' => 'O seu cargo',
        'select_contact_department' => 'Selecione o departamento…',
        'select_contact_position' => 'Selecione o cargo…',
        'your_name' => 'Seu nome',
        'email' => 'E-mail',
        'password' => 'Senha',
        ...
        'signup_facebook' => 'Continuar com Facebook',
        'social_not_available_for_company_signup' => 'O registo social não está disponível para criação de empresa.',
        'social_auth_failed' => 'Não foi possível concluir o acesso social. Tente novamente.',
        'social_email_required' => 'Não foi possível obter o seu e-mail da rede social. Use o formulário de registo.',
