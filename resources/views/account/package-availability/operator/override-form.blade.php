...
@extends('layouts.base', ['title' => $isEdit ? __('account.package_availability.override_edit_page_title') : __('account.package_availability.override_create_page_title')])
            ...
            <div class="row">
                <div class="col-lg-12">
                    <x-account-page-header
                        :title="$isEdit ? __('account.package_availability.override_edit_heading') : __('account.package_availability.override_create_heading')"
                        :subtitle="$catalogLabel"
                        :instructions="__('account.package_availability.override_form_instructions')"
                    />
                </div>
            </div>
