@php
    ...
    if (is_array($assignmentsOld)) {
        ...
        $assignments = $priceList->assignments
            ->map(fn ($a) => [
                'operator_account_id' => $a->assigned_to_id,
            ...
            <div class="row mt-3">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            @if ($hasOperators)
                                <form method="POST" action="{{ route('account.price-lists.assignments.update', $priceList) }}">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="d-flex flex-wrap gap-2 mt-4">
                                        <a class="btn btn-light" href="{{ route('account.price-lists.index') }}">{{ __('account.price_lists.assignments_cancel') }}</a>
                                        <a class="btn btn-outline-secondary" href="{{ route('account.price-lists.edit', $priceList) }}">{{ __('account.price_lists.assignments_edit_prices') }}</a>
