            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-md-between gap-3">
                        ...
                        <div>
                            <a href="{{ route('account.price-lists.create') }}" class="btn btn-primary">
                                        ...
                                        @foreach ($priceLists as $priceList)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @endphp
                                                    <a
                                                        href="{{ route('account.price-lists.assignments.edit', $priceList) }}"
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-end gap-2">
                                                        <a href="{{ route('account.price-lists.edit', $priceList) }}" class="btn btn-sm btn-outline-primary">
                                                            {{ __('account.price_lists.edit_button') }}
                                                        </a>
                                                        <form method="POST" action="{{ route('account.price-lists.destroy', $priceList) }}" onsubmit="return confirm('{{ __('account.price_lists.delete_confirm') }}')">
                                                            @csrf
                                                            @method('DELETE')
