                        ...
                        @foreach ($services as $svc)
                            <tr>
                                ...
                                <td class="text-center">
                                    @if (\App\Support\ServiceWizardSkipsVariantsStep::isSkippedForServiceTypeCode($svc->serviceType?->code))
                                        <span class="text-muted small">—</span>
                                    @else
                                    ...
                                    @if ($svc->serviceType)
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                @unless (\App\Support\ServiceWizardSkipsVariantsStep::isSkippedForServiceTypeCode($svc->serviceType->code))
                                                <li>
                                                    <a
                                                ...
                                                <li>
                                                    <a
                                                        href="{{ route('services.wizard.step7', ['serviceType' => $svc->serviceType->code, 'service' => $svc->id]) }}"
                                                        class="dropdown-item"
                                                    >
                                                ...
                                                @if (\App\Support\ServiceWizardStepEight::isEnabledForServiceTypeCode($svc->serviceType->code))
                                                    <li>
                                                        <a
                                                            href="{{ route('services.wizard.step8', ['serviceType' => $svc->serviceType->code, 'service' => $svc->id]) }}"
                                                            class="dropdown-item"
                                                        >
