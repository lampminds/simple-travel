            ...
            <ul class="fi-sidebar-nav-groups">
                @foreach ($navigation as $group)
                    @php
                        ...
                        $groupLabelRaw = $group->getLabel();
                        $groupLabel = $groupLabelRaw !== null && $groupLabelRaw !== '' ? __($groupLabelRaw) : $groupLabelRaw;
                ...
                if (collapsedGroups === null || collapsedGroups === 'null') {
                    localStorage.setItem(
                        ...
                        collect($navigation)
                            ...
                            ->map(function (\Filament\Navigation\NavigationGroup $group): string {
                                $label = $group->getLabel();
                                return $label !== null && $label !== '' ? (string) __($label) : (string) $label;
                            })
                            ->values()
                            ->all()
                    )),
