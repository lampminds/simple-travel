...
Artisan::command('service-feature-scopes:import {--dry-run : Show what would be created/updated without writing}', function (): void {
    ...
    $allScopeCodes = ['accomodation', 'gastronomy', 'activity', 'event', 'transport'];

    $typeIdsByCode = ServiceType::query()->pluck('id', 'code')->all();

    $rows = normalize_mojibake([
        ['code' => 'wifi', 'scopes' => $allScopeCodes],
        ['code' => 'charging_station', 'scopes' => ['accomodation', 'gastronomy', 'transport']],
        ['code' => 'parking', 'scopes' => ['accomodation', 'gastronomy', 'transport']],
        ['code' => 'indoor', 'scopes' => ['accomodation', 'gastronomy']],
        ['code' => 'outdoor', 'scopes' => ['gastronomy', 'activity', 'event']],
        ['code' => 'terrace', 'scopes' => ['gastronomy', 'accomodation']],
        ['code' => 'garden', 'scopes' => ['accomodation', 'gastronomy']],
        ['code' => 'pool', 'scopes' => ['accomodation']],
        ['code' => 'spa', 'scopes' => ['accomodation']],
        ['code' => 'gym', 'scopes' => ['accomodation']],
        ['code' => 'restroom', 'scopes' => ['gastronomy', 'activity', 'event', 'transport']],
        ['code' => 'reception_24h', 'scopes' => ['accomodation']],
        ['code' => 'housekeeping', 'scopes' => ['accomodation']],
        ['code' => 'room_service', 'scopes' => ['accomodation']],
        ['code' => 'car_rental', 'scopes' => ['accomodation']],
        ['code' => 'shuttle_service', 'scopes' => ['accomodation', 'activity', 'event']],
        ...
        ['code' => 'breakfast_included', 'scopes' => ['accomodation']],
        ['code' => 'restaurant_on_site', 'scopes' => ['accomodation']],
        ['code' => 'bar_on_site', 'scopes' => ['accomodation']],
        ['code' => 'drinks_included', 'scopes' => ['activity', 'event', 'gastronomy']],
        ['code' => 'alcohol_available', 'scopes' => ['gastronomy', 'activity', 'event']],
        ['code' => 'vegetarian_options', 'scopes' => ['gastronomy']],
        ['code' => 'vegan_options', 'scopes' => ['gastronomy']],
        ['code' => 'gluten_free_options', 'scopes' => ['gastronomy']],
        ['code' => 'guided', 'scopes' => ['activity', 'event', 'gastronomy']],
        ['code' => 'private', 'scopes' => $allScopeCodes],
        ['code' => 'group_friendly', 'scopes' => $allScopeCodes],
        ['code' => 'interactive', 'scopes' => ['activity', 'event', 'gastronomy']],
        ['code' => 'educational', 'scopes' => ['activity', 'event']],
        ['code' => 'adventure', 'scopes' => ['activity', 'event']],
        ['code' => 'cultural', 'scopes' => ['activity', 'event', 'gastronomy']],
        ...
        ['code' => 'accessible_restroom', 'scopes' => ['accomodation', 'gastronomy']],
        ['code' => 'elevator', 'scopes' => ['accomodation']],
        ['code' => 'romantic', 'scopes' => ['accomodation', 'gastronomy']],
        ['code' => 'family_friendly', 'scopes' => $allScopeCodes],
        ['code' => 'adults_only', 'scopes' => ['accomodation', 'gastronomy']],
        ['code' => 'quiet', 'scopes' => ['accomodation']],
        ['code' => 'lively', 'scopes' => ['gastronomy']],
        ['code' => 'city_center', 'scopes' => $allScopeCodes],
        ['code' => 'beachfront', 'scopes' => ['accomodation', 'gastronomy']],
        ['code' => 'lakeside', 'scopes' => ['accomodation', 'gastronomy']],
        ['code' => 'mountain_area', 'scopes' => ['accomodation', 'activity', 'event']],
        ['code' => 'rural_area', 'scopes' => $allScopeCodes],
        ['code' => 'panoramic_view', 'scopes' => ['accomodation', 'gastronomy']],
        ['code' => 'reservation_required', 'scopes' => ['gastronomy', 'activity', 'event']],
...
// Daily: fetch buy/sell rates from dolarapi.com (official casa) into currency_rates.
// Time comes from the system parameter `daily_update_time` (fallback 10:10).
$currencyRatesDailyTime = '10:10';
try {
    $currencyRatesDailyTime = app(ParameterReaderController::class)->dailyUpdateTime();
} catch (\Throwable) {
    // DB may be unavailable during install; keep default.
}

Schedule::command('currency:fetch-dolarapi-rates')->dailyAt($currencyRatesDailyTime);
